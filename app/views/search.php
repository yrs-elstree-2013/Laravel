...
<?php include(app_path().'/includes/_titlebar.php') ?>
    ...
    <div class="body-content">
		<ol>
			...
			<img src="http://placehold.it/350x200" style="float:right; margin:0 10px 0 10px;"/>
			<div style="width:600px;">
			<a href="#page"><span>Linked1</span></a>
			<a href="#page"><span>Linked2</span></a>
			<a href="#page"><span>Linked3</span></a>
			</div>
			</li>
			<li style="list-style-type: none; float:left;">
			<a href="#link"><h5 style="padding:0; margin:0; font-size:16pt;">Title</h5></a>
